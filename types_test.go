...
func (o *Object) MarshalEsm() ([]byte, error) {
	return esm.Marshal(o.n)
}

func (o *Object) UnmarshalEsm(b []byte) error {
	return esm.Unmarshal(b, &o.n)
}
...
var _ esm.CustomEncoder = (*IntSet)(nil)
var _ esm.CustomDecoder = (*IntSet)(nil)

func (set IntSet) EncodeEsm(enc *esm.Encoder) error {
...
func (setptr *IntSet) DecodeEsm(dec *esm.Decoder) error {
...
var _ esm.CustomEncoder = (*CustomEncoder)(nil)
var _ esm.CustomDecoder = (*CustomEncoder)(nil)

func (s *CustomEncoder) EncodeEsm(enc *esm.Encoder) error {
	if s == nil {
...
func (s *CustomEncoder) DecodeEsm(dec *esm.Decoder) error {
...
type OmitEmptyTest struct {
	Foo string `esm:",omitempty"`
	Bar string `esm:",omitempty"`
}
...
func TestEncoder(t *testing.T) {
	for _, test := range encoderTests {
		...
		enc := esm.NewEncoder(&buf).SortMapKeys(true)
...
func TestDecoder(t *testing.T) {
	for i, test := range decoderTests {
		err := esm.Unmarshal(test.b, test.out)
		if err == nil {
...
var (
	...
	repoURL, _ = url.Parse("https://../esm")
	typeTests  = []typeTest{
		{in: make(chan bool), encErr: "esm: Encode(unsupported chan bool)"},

		{in: nil, out: nil, decErr: "esm: Decode(nil)"},
		{in: nil, out: 0, decErr: "esm: Decode(nonsettable int)"},
		{in: nil, out: (*int)(nil), decErr: "esm: Decode(nonsettable *int)"},
		{in: nil, out: new(chan bool), decErr: "esm: Decode(unsupported chan bool)"},
		...
		{in: [3]byte{1, 2, 3}, out: new([2]byte), decErr: "[2]uint8 len is 2, but esm has 3 elements"},
		...
		{in: [3]int{1, 2, 3}, out: new([2]int), decErr: "[2]int len is 2, but esm has 3 elements"},
