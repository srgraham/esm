...
func (t *EsmTest) SetUpTest(c *C) {
	t.buf = &bytes.Buffer{}
	t.enc = esm.NewEncoder(t.buf)
	t.dec = esm.NewDecoder(bufio.NewReader(t.buf))
}

func (t *EsmTest) TestUint64(c *C) {
	table := []struct {
		v uint64
		b []byte
	}{
...
func (t *EsmTest) TestFloat32(c *C) {
	table := []struct {
		v float32
		b []byte
	}{
...
func (t *EsmTest) TestFloat64(c *C) {
	table := []struct {
		v float64
		b []byte
	}{
...
func (t *EsmTest) TestDecodeNil(c *C) {
	c.Assert(t.dec.Decode(nil), NotNil)
}

func (t *EsmTest) TestTime(c *C) {
	in := time.Now()
	var out time.Time
	c.Assert(t.enc.Encode(in), IsNil)
	c.Assert(t.dec.Decode(&out), IsNil)
...
func (t *EsmTest) TestLargeBytes(c *C) {
	N := int(1e6)
...
func (t *EsmTest) TestLargeString(c *C) {
	N := int(1e6)
...
func (t *EsmTest) TestSliceOfStructs(c *C) {
...
func (t *EsmTest) TestStructNil(c *C) {
	var dst *nameStruct
...
func (t *EsmTest) TestStructUnknownField(c *C) {
	in := struct {
		Field1 string
		Field2 string
		Field3 string
...
var (
	_ esm.CustomEncoder = (*coderStruct)(nil)
	_ esm.CustomDecoder = (*coderStruct)(nil)
)
...
func (s *coderStruct) EncodeEsm(enc *esm.Encoder) error {
	return enc.Encode(s.name)
}

func (s *coderStruct) DecodeEsm(dec *esm.Decoder) error {
	return dec.Decode(&s.name)
}

func (t *EsmTest) TestCoder(c *C) {
...
func (t *EsmTest) TestNilCoder(c *C) {
	in := &coderStruct{name: "hello"}
	var out *coderStruct
	c.Assert(t.enc.Encode(in), IsNil)
	c.Assert(t.dec.Decode(&out), IsNil)
...
func (t *EsmTest) TestNilCoderValue(c *C) {
	in := &coderStruct{name: "hello"}
	var out *coderStruct
	c.Assert(t.enc.Encode(in), IsNil)
...
func (t *EsmTest) TestPtrToCoder(c *C) {
	in := &coderStruct{name: "hello"}
	var out coderStruct
	out2 := &out
	c.Assert(t.enc.Encode(in), IsNil)
...
func (t *EsmTest) TestWrappedCoder(c *C) {
...
func (t *EsmTest) TestNestedStructs(c *C) {
...
func (t *EsmTest) TestSliceNil(c *C) {
	in := [][]*int{nil}
	var out [][]*int
...
func (t *EsmTest) TestMapStringInterface(c *C) {
